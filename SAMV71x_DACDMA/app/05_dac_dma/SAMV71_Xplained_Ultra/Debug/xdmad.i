# 1 "C:\\Users\\Willy\\Documents\\Mirror\\ITESO_ES\\Embedded_Systems\\DMA_DAC\\SAMV71x_Tezmol\\hal\\libchip_samv7\\source\\xdmad.c"
...
#define ENABLE_TCM 1
# 1 "C:\\Users\\Willy\\Documents\\Mirror\\ITESO_ES\\Embedded_Systems\\DMA_DAC\\SAMV71x_Tezmol\\hal\\libchip_samv7\\source\\xdmad.c"
# 64 "C:\\Users\\Willy\\Documents\\Mirror\\ITESO_ES\\Embedded_Systems\\DMA_DAC\\SAMV71x_Tezmol\\hal\\libchip_samv7\\source\\xdmad.c"
...
# 65 "C:\\Users\\Willy\\Documents\\Mirror\\ITESO_ES\\Embedded_Systems\\DMA_DAC\\SAMV71x_Tezmol\\hal\\libchip_samv7\\source\\xdmad.c" 2
# 1 "c:\\isystem\\winideaopen9\\gcc\\arm\\arm-none-eabi\\include\\assert.h" 1 3
# 11 "c:\\isystem\\winideaopen9\\gcc\\arm\\arm-none-eabi\\include\\assert.h" 3
#undef assert
...
void __assert_func (const char *, int, const char *, const char *) __attribute__ ((__noreturn__))
                                 ;
# 66 "C:\\Users\\Willy\\Documents\\Mirror\\ITESO_ES\\Embedded_Systems\\DMA_DAC\\SAMV71x_Tezmol\\hal\\libchip_samv7\\source\\xdmad.c" 2
static uint8_t xDmad_Initialized = 0;
# 79 "C:\\Users\\Willy\\Documents\\Mirror\\ITESO_ES\\Embedded_Systems\\DMA_DAC\\SAMV71x_Tezmol\\hal\\libchip_samv7\\source\\xdmad.c"
           ...
           uint8_t bDstID)
{
 ...
 if ( bDstID == 0xFF) {
  if( (!XDMAIF_IsValidatedPeripherOnDma(bSrcID)) ) {
   { printf("-E- " "%s:: Allocation failed", __FUNCTION__); };
   return 0xFFFF;
  }
 }
 ...
 { printf("-E- " "%s:: Allocation failed, all channels are occupied", __FUNCTION__); };
 return 0xFFFF;
}
# 137 "C:\\Users\\Willy\\Documents\\Mirror\\ITESO_ES\\Embedded_Systems\\DMA_DAC\\SAMV71x_Tezmol\\hal\\libchip_samv7\\source\\xdmad.c"
void XDMAD_Initialize( sXdmad *pXdmad, uint8_t bPollingMode )
{
 uint32_t j;
 uint32_t volatile timer=0x7FF;

 ((pXdmad) ? (void)0 : __assert_func ("C:\\Users\\Willy\\Documents\\Mirror\\ITESO_ES\\Embedded_Systems\\DMA_DAC\\SAMV71x_Tezmol\\hal\\libchip_samv7\\source\\xdmad.c", 142, __FUNCTION__, "pXdmad")) ;
 get_lock(&pXdmad->xdmaMutex, 1, &timer);
 if (xDmad_Initialized) {
  free_lock(&pXdmad->xdmaMutex);
  return;
 }
 pXdmad->pXdmacs = ((Xdmac *)0x40078000U);
 pXdmad->pollingMode = bPollingMode;
 pXdmad->numControllers = 1;
 pXdmad->numChannels = ((((0x1fu << 0) & ((XDMAC_GetType(((Xdmac *)0x40078000U))) << 0))) + 1);
...
# 178 "C:\\Users\\Willy\\Documents\\Mirror\\ITESO_ES\\Embedded_Systems\\DMA_DAC\\SAMV71x_Tezmol\\hal\\libchip_samv7\\source\\xdmad.c"
uint32_t XDMAD_AllocateChannel( sXdmad *pXdmad,
        uint8_t bSrcID,
        uint8_t bDstID)
{
 uint32_t dwChannel = 0xFFFF;
 uint32_t volatile timer=0x7FF;
       ...
       uint32_t dwChannel )
{
 ...
 ((pXdmad != ((void *)0)) ? (void)0 : __assert_func ("C:\\Users\\Willy\\Documents\\Mirror\\ITESO_ES\\Embedded_Systems\\DMA_DAC\\SAMV71x_Tezmol\\hal\\libchip_samv7\\source\\xdmad.c", 201, __FUNCTION__, "pXdmad != NULL")) ;
...
# 223 "C:\\Users\\Willy\\Documents\\Mirror\\ITESO_ES\\Embedded_Systems\\DMA_DAC\\SAMV71x_Tezmol\\hal\\libchip_samv7\\source\\xdmad.c"
       ...
       void* pArg )
{
 ...
 uint8_t iChannel = (dwChannel) & 0xFF;
 ((pXdmad != ((void *)0)) ? (void)0 : __assert_func ("C:\\Users\\Willy\\Documents\\Mirror\\ITESO_ES\\Embedded_Systems\\DMA_DAC\\SAMV71x_Tezmol\\hal\\libchip_samv7\\source\\xdmad.c", 230, __FUNCTION__, "pXdmad != NULL")) ;
 if (iChannel >= pXdmad->numChannels) return XDMAD_ERROR;
...
# 251 "C:\\Users\\Willy\\Documents\\Mirror\\ITESO_ES\\Embedded_Systems\\DMA_DAC\\SAMV71x_Tezmol\\hal\\libchip_samv7\\source\\xdmad.c"
eXdmadRC XDMAD_PrepareChannel( sXdmad *pXdmad, uint32_t dwChannel)
{
 ...
 ((pXdmad != ((void *)0)) ? (void)0 : __assert_func ("C:\\Users\\Willy\\Documents\\Mirror\\ITESO_ES\\Embedded_Systems\\DMA_DAC\\SAMV71x_Tezmol\\hal\\libchip_samv7\\source\\xdmad.c", 257, __FUNCTION__, "pXdmad != NULL")) ;
 if (iChannel >= pXdmad->numChannels) return XDMAD_ERROR;
 ...
 if (!PMC_IsPeriphEnabled( (58) )) {
  PMC_EnablePeripheral( (58) );
 }
...
void XDMAD_Handler( sXdmad *pDmad)
{
 ...
 uint8_t bExec = 0;
 uint8_t _iChannel;
 ((pDmad != ((void *)0)) ? (void)0 : __assert_func ("C:\\Users\\Willy\\Documents\\Mirror\\ITESO_ES\\Embedded_Systems\\DMA_DAC\\SAMV71x_Tezmol\\hal\\libchip_samv7\\source\\xdmad.c", 298, __FUNCTION__, "pDmad != NULL")) ;
 ...
 if ((xdmaGlobaIntStatus & 0xFFFFFF) != 0) {
  ...
  for (_iChannel = 0; _iChannel < pDmad->numChannels; _iChannel ++) {
   ...
   if ((xdmaGlobalChStatus & ( (0x1u << 0) << _iChannel)) == 0) {
    bExec = 0;
    xdmaChannelIntStatus = XDMAC_GetMaskChannelIsr( pXdmac, _iChannel);
    if (xdmaChannelIntStatus & (0x1u << 0)) {
     if((XDMAC_GetChannelItMask(pXdmac, _iChannel) & (0x1u << 1))
       == 0 ) {
    ...
    if (xdmaChannelIntStatus & (0x1u << 3)) {
     { };
    }
    if (xdmaChannelIntStatus & (0x1u << 4)) {
     { };
    }
    if (xdmaChannelIntStatus & (0x1u << 5)) {
     { };
    }
    if (xdmaChannelIntStatus & (0x1u << 6)) {
     { };
    }
    if (xdmaChannelIntStatus & (0x1u << 1)) {
     { };
     pCh->state = XDMAD_STATE_DONE ;
     bExec = 1;
    }
    if (xdmaChannelIntStatus & (0x1u << 2) )
    {
     pCh->state = XDMAD_STATE_DONE ;
     bExec = 1;
    }
    ...
    if( XDMAC_GetChannelIsr( pXdmac, _iChannel) & (0x1u << 0)) {
...
eXdmadRC XDMAD_IsTransferDone( sXdmad *pXdmad, uint32_t dwChannel )
{
 uint8_t iChannel = (dwChannel) & 0xFF;
 uint8_t state;
 ((pXdmad != ((void *)0)) ? (void)0 : __assert_func ("C:\\Users\\Willy\\Documents\\Mirror\\ITESO_ES\\Embedded_Systems\\DMA_DAC\\SAMV71x_Tezmol\\hal\\libchip_samv7\\source\\xdmad.c", 368, __FUNCTION__, "pXdmad != NULL")) ;
...
# 390 "C:\\Users\\Willy\\Documents\\Mirror\\ITESO_ES\\Embedded_Systems\\DMA_DAC\\SAMV71x_Tezmol\\hal\\libchip_samv7\\source\\xdmad.c"
        ...
        uint32_t dwXdmaIntEn)
{
 ...
 ((pXdmad != ((void *)0)) ? (void)0 : __assert_func ("C:\\Users\\Willy\\Documents\\Mirror\\ITESO_ES\\Embedded_Systems\\DMA_DAC\\SAMV71x_Tezmol\\hal\\libchip_samv7\\source\\xdmad.c", 399, __FUNCTION__, "pXdmad != NULL")) ;
 if (iChannel >= pXdmad->numChannels)
  return XDMAD_ERROR;
 ...
 if ((dwXdmaDescCfg & (0x1u << 0)) == (0x1u << 0)) {
  if ((dwXdmaDescCfg & (0x3u << 3)) == (0x0u << 3)) {
  ...
  if ((dwXdmaDescCfg & (0x3u << 3)) == (0x1u << 3)) {
   XDMAC_SetChannelConfig( pXdmac, iChannel, pXdmaParam->mbr_cfg );
  }
...
eXdmadRC XDMAD_StartTransfer( sXdmad *pXdmad, uint32_t dwChannel )
{
 ...
 ((pXdmad != ((void *)0)) ? (void)0 : __assert_func ("C:\\Users\\Willy\\Documents\\Mirror\\ITESO_ES\\Embedded_Systems\\DMA_DAC\\SAMV71x_Tezmol\\hal\\libchip_samv7\\source\\xdmad.c", 450, __FUNCTION__, "pXdmad != NULL")) ;
 if (iChannel >= pXdmad->numChannels) return XDMAD_ERROR;

 Xdmac *pXdmac = pXdmad->pXdmacs;
 if ( pXdmad->XdmaChannels[iChannel].state == XDMAD_STATE_FREE ) {
  { printf("-E- " "%s:: XDMAD_STATE_FREE \n\r", __FUNCTION__); };
  return XDMAD_ERROR;
 } else if ( pXdmad->XdmaChannels[iChannel].state == XDMAD_STATE_START ) {
  { printf("-E- " "%s:: XDMAD_STATE_START \n\r", __FUNCTION__); }
  return XDMAD_BUSY;
 }
...
eXdmadRC XDMAD_StopTransfer( sXdmad *pXdmad, uint32_t dwChannel )
{
 ...
 ((pXdmad != ((void *)0)) ? (void)0 : __assert_func ("C:\\Users\\Willy\\Documents\\Mirror\\ITESO_ES\\Embedded_Systems\\DMA_DAC\\SAMV71x_Tezmol\\hal\\libchip_samv7\\source\\xdmad.c", 479, __FUNCTION__, "pXdmad != NULL")) ;
