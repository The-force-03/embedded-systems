...
tSchedulingTask EventTriggeredTasks[TASK_SCH_MAX_NUMBER_EVENT_TASKS] =
{
...
tSchedulingTask EventTriggeredTasksInternal[TASK_SCH_MAX_NUMBER_EVENT_TASKS] =
{
    {TASK_NULL, NULL, SUSPENDED, 0},
    {TASK_NULL, NULL, SUSPENDED, 0},
    {TASK_NULL, NULL, SUSPENDED, 0},
...
* \brief    Multi-thread round robin task Scheduler  (non-preemtive)        \n
            ...
            callback function "vfnScheduler_Callback"                       \n
